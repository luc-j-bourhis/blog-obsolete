...
L'information contenue dans chaque paire, ou du moins celle qui aura une influence sur les mesures, sera notée $$\lambda$$, qui est aussi appelée l'état de la paire. À priori, on ne sait rien de $$\lambda$$. Prenons l'exemple où les particules sont des photons dont on mesure la polarisation. On serait tenter de dire que $$\lambda$$ contient au moins la polarisation des deux particules, et aussi d'autres éléments d'information pour lesquels nous n'avons pas d'accès direct par l'observation: ces derniers sont les fameuses variables cachées. Cela semble naturel, car l'idée même de mesurer les polarisations semble impliquer que ces polarisations soient des propriétés des particules qui existaient avant la mesure. Un tel argument fut dévelopé par [[Einstein:1935aa]], et il constitua une des inspirations de [[Bell:1964]], comme le montre clairement le titre de l'article. Mais en fait, il se pourrait très bien que la polarisation ne fasse pas du tout partie de cet état $$\lambda$$: la polarisation pourrait être un phénomène émergeant lors de la mesure, déterminé par d'autres propriétés de la particule, et ces propriétés sont représentées par $$\lambda$$. L'une et l'autre possibilité sont acceptables ici. Elles correspondent à deux types différents de modèles mais l'un comme l'autre permettent de déduire des inégalités de Bell.
