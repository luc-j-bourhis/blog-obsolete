...
Je vais présenter une expérience idéalisée. Nombre des expériences réelles furent réaliser avec des paires de photons mais je vais considérer des paires d'électrons pour des raisons historiques et pédagogiques. Les paires d'électrons avec leur spin fortement corrélés furent en effet l'expérience de pensée que Bell utilisa pour démontrer les inégalités qui portent maintenant son nom. Une expérience récente et importante, [[Hensen:2015]],fut réalisée avec de telles paires mais les détails expérimentaux diffèrent significativement de l'expérience idéalisée que je vais présenter: c'est un choix pédagogique de ma part.

Il y a en premier lieu une source qui émet une à une des paires d'électrons qui sont, est-il besoin de le rappeler, des particules de spin 1/2. Ces paires sont produites dans un état de spin total nul. Pour chaque paire, l'une des particules, notée 1, va vers un appareil de mesure I tandis que l'autre, notée 2, va vers un appareil de mesure II. Le détecteur I va mesurer le spin de la particule 1 dans la direction $$a$$ (un vecteur unitaire) tandis que le détecteur II mesurera le spin de la particule 2 dans la direction $$b$$ (un autre vecteur unitaire, à priori différent de $$a$$). Par conséquent, ces mesures ne peuvent prendre que les valeurs $$\pm\hbar/2$$. Par soucis de concision, je vais mesurer les spins en unité de $$\hbar/2$$, et par conséquent les mesures ne prendront que les valeurs $$\pm 1$$.
