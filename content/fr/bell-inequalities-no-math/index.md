...
Alice ajoute: «Et nous avons une règle III. Mieux, les trois règles que nous avons trouvé couvrent tous les cas de choix des faces X. Nous avons la description ultime de la procédure suivie par Luc! Les trois règles sont consistantes. Le jeu est fini, non?»
...
Alice: «Pas bête! On pourrait nommé ce problème la "lacune de localité" car la mesure de la couleur du jeton doit être strictement locale, au sens où elle n'est influencé que par le jeton et le réglage de ce détecteur là, et par rien d'autre pour que le théorème de Jessica marche. Cette lacune est exactement ce que Jessica a identifié: une hypothèse que nous avons faites sans nous en rendre compte.»

Alice ajoute immédiatement: «Mais la parade est aisée: au lieu de faire quatre expérience avec les détecteurs réglés à l'avance, on pourrait faire une seule expérience où chacun d'entre nous choisirait au hasard la face à observer. À la fin, il suffit de sélectionner les combinaisons que Luc avait choisies et ignorer le reste.»
...
Elle poursuit: «Passons à l'expérience proprement dite maintenant. Quand je fais une observation, je note non seulement le résultat mais le temps indiqué par mon horloge. Chacun de vous fait de même. Pour chaque mesure, nous comparons alors ces temps. Par exemple, disons que nos notes montrent que Paul a fait sa mesure une seconde après moi: si il avait fallu plus d'une seconde au signal lumineux pour aller de moi à Paul, alors la mesure de Paul n'a pas pu être influencer par mon détecteur. Même chose entre moi et Alice et entre Paul et Alice.»

Alice et Paul regarde Jessica avec admiration et explose de joie: «Superbe! Faisons cette expérience, avec le tirage au hasard du compartiment observé, et la compilation des instants des ces observations. Si Luc veut se prêter au jeu bien entendu!»
